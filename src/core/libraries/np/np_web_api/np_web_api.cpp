...
static void RegisterLibraryHooks() {
    ...
    SHADNET_HOOK16(Libraries::Np::NpWebApi, sceNpWebApiAbortHandle);
    SHADNET_HOOK16(Libraries::Np::NpWebApi, sceNpWebApiAbortRequest);
    ...
    SHADNET_HOOK16(Libraries::Np::NpWebApi, sceNpWebApiClearAllUnusedConnection);
    ...
    SHADNET_HOOK16(Libraries::Np::NpWebApi, sceNpWebApiCreateHandle);
    ...
    SHADNET_HOOK(Libraries::Np::NpWebApi, sceNpWebApiCreateServicePushEventFilter);
    SHADNET_HOOK16(Libraries::Np::NpWebApi, sceNpWebApiDeleteContext);
    SHADNET_HOOK16(Libraries::Np::NpWebApi, sceNpWebApiDeleteExtdPushEventFilter);
    SHADNET_HOOK16(Libraries::Np::NpWebApi, sceNpWebApiDeleteHandle);
    SHADNET_HOOK16(Libraries::Np::NpWebApi, sceNpWebApiDeletePushEventFilter);
    SHADNET_HOOK16(Libraries::Np::NpWebApi, sceNpWebApiDeleteRequest);
    SHADNET_HOOK16(Libraries::Np::NpWebApi, sceNpWebApiDeleteServicePushEventFilter);
    ...
    SHADNET_HOOK16(Libraries::Np::NpWebApi, sceNpWebApiGetMemoryPoolStats);
    ...
    SHADNET_HOOK16(Libraries::Np::NpWebApi, sceNpWebApiSetHandleTimeout);
    SHADNET_HOOK16(Libraries::Np::NpWebApi, sceNpWebApiSetMaxConnection);
    SHADNET_HOOK(Libraries::Np::NpWebApi, sceNpWebApiSetMultipartContentType);
    SHADNET_HOOK16(Libraries::Np::NpWebApi, sceNpWebApiSetRequestTimeout);
    SHADNET_HOOK(Libraries::Np::NpWebApi, sceNpWebApiTerminate);
    SHADNET_HOOK16(Libraries::Np::NpWebApi, sceNpWebApiUnregisterExtdPushEventCallback);
    SHADNET_HOOK16(Libraries::Np::NpWebApi, sceNpWebApiUnregisterNotificationCallback);
    SHADNET_HOOK16(Libraries::Np::NpWebApi, sceNpWebApiUnregisterPushEventCallback);
    SHADNET_HOOK16(Libraries::Np::NpWebApi, sceNpWebApiUnregisterServicePushEventCallback);
