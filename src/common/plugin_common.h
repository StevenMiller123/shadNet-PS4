// From https://github.com/GoldHEN/GoldHEN_Plugins_Repository/blob/main/common/plugin_common.h
...
#define attr_aligned __attribute__((__force_align_arg_pointer__))
